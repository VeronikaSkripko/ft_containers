...
void vector_constructor_check()
{
	...
	Vector<int> first_ft;
	Vector<int> second_ft(4, 100);
	Vector<int> third_ft(second_ft.begin(), second_ft.end());
	Vector<int> fourth_ft(third_ft);
	Vector<int> fifth_ft(myints, myints + sizeof(myints) / sizeof(int));

	Vector<int>::iterator it_ft = first_ft.begin();
...
void vector_begin_check()
{
	...
	Vector<int>::iterator it_ft = myvector_ft.begin();
...
void vector_rbegin_check()
{
	...
	Vector<int> myvector_ft(5);
	bool res = true;
	int i = 0;
	std::vector<int>::reverse_iterator rit = myvector.rbegin();
	Vector<int>::reverse_iterator rit_ft = myvector_ft.rbegin();
...
void vector_maxsize_check()
{
	...
	Vector<int> myvector_ft;
	Vector<char> myvector2_ft;
	Vector<long> myvector3_ft;
	Vector<short> myvector5_ft;
	Vector<double> myvector6_ft;
...
void vector_swap_check()
{
	...
	foo.swap(bar);
	Vector<int> foo_ft(3, 100);
	Vector<int> bar_ft(5, 200);
	foo_ft.swap(bar_ft);

	std::vector<int>::iterator it_std = foo.begin();
	Vector<int>::iterator it_ft = foo_ft.begin();
...
void vector_iterator_check()
{
	...
	u1[2] = 300;
	u1[3] = 200;
	Vector<int>::iterator it_ft = u.begin();
	Vector<int>::iterator it_fte = u.end();
	Vector<int>::const_iterator it_constft = u.begin();
	Vector<int>::const_iterator it_constfte = u.end();
	Vector<int>::const_reverse_iterator it_constreverseft = u.rbegin();
	Vector<int>::const_reverse_iterator it_constreversefte = u.rend();
	...
	Vector<int>::const_iterator cit_1 = u.begin();
	Vector<int>::const_iterator cit_2 = u.begin() + 2;
	...
	Vector<int>::iterator it_1 = u.begin();
	Vector<int>::iterator it_2 = u.begin() + 2;
	std::vector<int>::iterator it_std1 = u1.begin();
	std::vector<int>::iterator it_std2 = u1.begin() + 2;
	ft_assert((it_std2 - it_std1), (it_2 - it_1));
	Vector<int>::const_reverse_iterator rit_1 = u.rbegin();
	Vector<int>::const_reverse_iterator rit_2 = u.rbegin() + 2;
...
void vector_getallocator_check()
{
	...
	for (i = 0; i < 5; i++)
		myvector_ft.get_allocator().construct(&p[i], i);
	for (i = 0; i < 5; i++)
		myvector.get_allocator().construct(&pft[i], i);
	std::vector<int>::iterator it_std = myvector.begin();
	Vector<int>::iterator it_ft = myvector_ft.begin();
	...
	std::cout << (res ? FGRN("[OK] ") : FRED("[KO] "));
	for (i = 0; i < 5; i++)
		myvector_ft.get_allocator().destroy(&p[i]);
	for (i = 0; i < 5; i++)
		myvector.get_allocator().destroy(&pft[i]);
