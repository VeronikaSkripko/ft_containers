...
void stack_constructor_check()
{
	...
	Vector<int> myvector_ft(2, 200);
	Stack<int> first_ft;
	Stack<int, Vector<int> > third_ft;
	Stack<int, Vector<int> > fourth_ft(myvector_ft);
	Stack<int, Vector<int> > fif_ft(fourth_ft);
...
void stack_empty_check()
{
	...
	Stack<int, std::deque<int> > mystack_ft;
	bool res = true;
...
void stack_push_check()
{
	...
	std::stack<int, Vector<int> > mystack;
	Stack<int, Vector<int> > mystack_ft;
	bool res = true;
	for (int i = 0; i < 5; ++i)
	{
		mystack.push(i);
