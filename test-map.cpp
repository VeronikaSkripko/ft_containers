...
void map_con_check()
{
	...
	bool res = true;
	Map<char, int> first_ft;
	first_ft['a'] = 10;
	first_ft['b'] = 30;
	first_ft['c'] = 50;
	first_ft['d'] = 70;
	Map<char, int> second_ft(first_ft.begin(), first_ft.end());
	Map<char, int> third_ft(second_ft);
	Map<char, int, classcomp> fourth_ft;
	bool (*fn_pt)(char, char) = fncomp;
	std::map<char, int, bool (*)(char, char)> fifth(fn_pt);
	Map<char, int, bool (*)(char, char)> fifth_ft(fn_pt);
	...
	Map<int, int>::iterator it_ft = map_ft.begin();
...
void map_begin_check()
{
	...
	mymap_ft['a'] = 200;
	mymap_ft['c'] = 300;
	Map<char, int>::iterator it_ft = mymap_ft.begin();
...
void map_swap_check()
{
	...
	Map<char, int>::iterator it_ft = foo_ft.begin();
...
void map_keycompare_check()
{
	...
	mymap['c'] = 300;
	Map<char, int> mymap_ft;
	Map<char, int>::key_compare mycomp_ft = mymap_ft.key_comp();
	mymap_ft['a'] = 100;
	mymap_ft['b'] = 200;
	mymap_ft['c'] = 300;
...
void map_lowerbound_check()
{
	...
	mymap['z'] = 100;
	Map<char, int> mymap_ft;
	Map<char, int>::iterator itlow_ft, itup_ft;
...
void map_equalrange_check()
{
	...
	ft::pair<Map<char, int>::iterator, Map<char, int>::iterator> ret_ft;
...
void map_iterator_check()
{
	...
	Map<int, char>::iterator it_ft;
	Map<int, char>::const_iterator const_it_ft;
	Map<int, char>::reverse_iterator rev_it_ft;
	Map<int, char>::const_reverse_iterator const_rev_it_ft;
